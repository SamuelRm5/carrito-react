        ...
        <div className={styles.cartContainer}>
            {
                ...
                <div
                    ...
                    className={`${styles.buttonCartContainer} animate__animated animate__headShake`}
                >
                ...
                <div className={styles.cart}>
                    ...
                    {cartItems.length === 0 ? (
                        <>
                            ...
                            <div
                                onClick={() => setCartOpen(!cartOpen)}
                                className={`${styles.buttonClose} animate__animated animate__headShake`}
                            >
                                <div className={styles.buttonCart}>
                                    {!cartOpen ? (
                                        <svg
                    ...
                    <h2 className={styles.total}>Total: ${Number(total).toLocaleString('en')}</h2>
